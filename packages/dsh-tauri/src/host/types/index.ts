...
export type HostContext = Context & { agents: AgentRegistry, sessions: SessionStore, workspaceRegistry: WorkspaceRegistry, tools: ToolRuntime & ToolRegistrationService, webServer: WebServerService, connection?: ConnectionGate, llm?: LlmRuntime, agentDefaultModel?: AgentDefaultModelService, agentPresets?: AgentPresetsService, permissionPresets?: PermissionPresetsService, loader: { import: (name: string) => Promise<unknown>, unwrapExports: (exports: unknown) => unknown } }
